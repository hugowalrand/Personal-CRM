...
export const GripVerticalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <circle cx="9" cy="12" r="1.5" fill="currentColor" stroke="none"></circle>
        <circle cx="9" cy="5" r="1.5" fill="currentColor" stroke="none"></circle>
        ...
        <circle cx="15" cy="5" r="1.5" fill="currentColor" stroke="none"></circle>
        <circle cx="15" cy="19" r="1.5" fill="currentColor" stroke="none"></circle>
    </svg>
);
...
export const TagIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 12l-4 4 4 4" />
    </svg>
);
